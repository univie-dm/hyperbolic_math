...
def smooth_clamp_min(
    x: torch.Tensor, min_value: float, smoothing_factor: float = 50
) -> torch.Tensor:
...
def smooth_clamp_max(
    x: torch.Tensor, max_value: float, smoothing_factor: float = 50
) -> torch.Tensor:
...
@torch.jit.script
def smooth_clamp(
    x: torch.Tensor, min_value: float, max_value: float, smoothing_factor: float = 50
) -> torch.Tensor:
